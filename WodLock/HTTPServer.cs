...
public class HttpServer
{
    ...
    private void ListenerCallback(IAsyncResult result)
    {
        if (Listener.IsListening)
        {
            ...
            if (request.HttpMethod == "POST")
            {
                ...
                Debug.WriteLine($"Recived request for {request.Url}");
    ...
    private bool CheckPurchasedProduct (string ResponseString)
    {
        return (ResponseString.Contains("product_purchase") & ResponseString.Contains("Woda"));
